...
Public Class TunePidForm
   ...
   Private Sub ButtonSend_Click(sender As Object, e As EventArgs) Handles ButtonSend.Click
      If m_dashValue(DVindex.dvPidSelect).revised       Then DashValue(DVindex.dvPidSelect, True)       = CDbl(ListPID.SelectedIndex)
      If m_dashValue(DVindex.dvPidSetpoint).revised     Then DashValue(DVindex.dvPidSetpoint, True)     = ConvertToDouble(TextSetpoint.Text)
      If m_dashValue(DVindex.dvPidMaxOut).revised       Then DashValue(DVindex.dvPidMaxOut, True)       = ConvertToDouble(TextMaxOut.Text)
      If m_dashValue(DVindex.dvPidPthreshold).revised   Then DashValue(DVindex.dvPidPthreshold, True)   = ConvertToDouble(TextPThreshold.Text)
      If m_dashValue(DVindex.dvPidPabove).revised       Then DashValue(DVindex.dvPidPabove, True)       = ConvertToDouble(TextPAbove.Text)
      If m_dashValue(DVindex.dvPidPbelow).revised       Then DashValue(DVindex.dvPidPbelow, True)       = ConvertToDouble(TextPBelow.Text)
      If m_dashValue(DVindex.dvPidIthreshold).revised   Then DashValue(DVindex.dvPidIthreshold, True)   = ConvertToDouble(TextIThreshold.Text)
      If m_dashValue(DVindex.dvPidIabove).revised       Then DashValue(DVindex.dvPidIabove, True)       = ConvertToDouble(TextIAbove.Text)
      If m_dashValue(DVindex.dvPidIbelow).revised       Then DashValue(DVindex.dvPidIbelow, True)       = ConvertToDouble(TextIBelow.Text)
      If m_dashValue(DVindex.dvPidDthreshold).revised   Then DashValue(DVindex.dvPidDthreshold, True)   = ConvertToDouble(TextDThreshold.Text)
      If m_dashValue(DVindex.dvPidDabove).revised       Then DashValue(DVindex.dvPidDabove, True)       = ConvertToDouble(TextDAbove.Text)
      If m_dashValue(DVindex.dvPidDbelow).revised       Then DashValue(DVindex.dvPidDbelow, True)       = ConvertToDouble(TextDBelow.Text)
